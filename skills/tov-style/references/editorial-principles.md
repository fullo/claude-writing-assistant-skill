# Editorial Principles — From the Masters

Principi editoriali universali estratti dai testi di riferimento per la scrittura. Questi principi si applicano a qualsiasi libro, in qualsiasi lingua. Gli agenti `book-reviewer`, `book-challenger` e `book-verifier` li usano come base per la revisione e la sfida editoriale.
...
**Regola Strunk & White:** Omit needless words. Una frase non deve contenere parole inutili, un paragrafo non deve contenere frasi inutili, per la stessa ragione per cui un disegno non deve contenere linee inutili.

## 2. Mostrare, non raccontare (King, Lamott)

**Principio:** il lettore deve vivere l'esperienza, non ricevere un riassunto.

**Cosa verificare:**
- Scene concrete con dettagli sensoriali vs. riassunti astratti
- Dialoghi che rivelano carattere e conflitto vs. esposizione diretta
...
**Per il reviewer:** non giudicare una prima bozza con gli stessi standard di un testo revisionato. Distinguere tra:
- Problemi strutturali (da segnalare subito)
...
- I personaggi hanno voci distinguibili?
- I dialoghi sono al servizio della narrazione (non riempitivi)?
- Max 4-5 battute consecutive senza commento narrativo dell'autore?
...
**Cosa verificare:**
- Nomi concreti al posto di categorie generiche ("Marco, il CTO" non "il responsabile tecnico")
- Numeri precisi al posto di vaghezze ("il 23% in Q3 2023" non "un aumento significativo")
- Esempi reali al posto di esempi ipotetici
- Situazioni specifiche al posto di principi astratti

**Strunk & White:** usare un linguaggio definito, specifico, concreto. Preferire lo specifico al generico, il definito al vago, il concreto all'astratto.
...
## 10. Scrivere per il lettore (King, Zinsser)

**Principio:** scrivi prima per te stesso, poi riscrivi per il lettore.
...
**book-verifier:** usare per verificare che il libro mantenga le promesse strutturali. Es. "Principio 5 — questo capitolo ha un arco narrativo completo?" o "Principio 8 — le metriche sono concrete e verificabili?"
